        ...
        <div className="pt-16 md:pt-32">
          ...
          <div className="grid md:grid-cols-3 gap-8 md:gap-12">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Modify content in your posts easily, using regex expressions.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Content translation</h4>
              </div>
              <p className="text-sm text-slate-400">Translate your content to over 130 languages via Google Translate.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Bulk updates</h4>
              </div>
              <p className="text-sm text-slate-400">Execute a single query to update hundreds of posts at once.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Import content from Google Sheets or Excel, and export it to CSV.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
              ...
              <p className="text-sm text-slate-400">Synchronize content across different sites, or a multisite network.</p>
            </div>
            {/* Feature */}
            <div>
              <div className="flex items-center space-x-2 mb-1">
                ...
                <h4 className="font-medium text-slate-50">Automation</h4>
              </div>
              <p className="text-sm text-slate-400">Trigger the execution of a query whenever some action happens.</p>
            </div>
          </div>
