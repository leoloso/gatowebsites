  ...
  return (
    <>
      ...
      <div className="flex h-[324px] items-center justify-center">
        ...
        {/* Horizontal lines */}
        {/* <div className="absolute inset-x-0 top-0 -z-10 h-px bg-gradient-to-r from-transparent via-purple-300/80 to-transparent mix-blend-multiply"></div>
        <div className="absolute inset-x-0 bottom-0 -z-10 h-px bg-gradient-to-r from-transparent via-purple-300/80 to-transparent mix-blend-multiply"></div> */}
        <div className="absolute inset-x-0 top-1/2 -z-10 h-px bg-gradient-to-r from-transparent via-purple-300/60 to-transparent mix-blend-multiply"></div>
        {/* <div className="absolute inset-x-0 top-1/2 -z-10 h-px -translate-y-[82px] bg-gradient-to-r from-transparent via-purple-300/80 to-transparent mix-blend-multiply before:absolute before:inset-y-0 before:w-24 before:animate-[line_10s_ease-in-out_infinite_both] before:bg-gradient-to-r before:via-purple-500"></div>
        <div className="absolute inset-x-0 top-1/2 -z-10 h-px translate-y-[82px] bg-gradient-to-r from-transparent via-purple-300/80 to-transparent mix-blend-multiply before:absolute before:inset-y-0 before:w-24 before:animate-[line_10s_ease-in-out_infinite_5s_both] before:bg-gradient-to-r before:via-purple-500"></div> */}
        {/* Diagonal lines */}
        <div className="absolute inset-x-0 top-1/2 -z-10 h-px rotate-[20deg] bg-gradient-to-r from-transparent via-purple-300/80 to-transparent mix-blend-multiply"></div>
        <div className="absolute inset-x-0 top-1/2 -z-10 h-px -rotate-[20deg] bg-gradient-to-r from-transparent via-purple-300/80 to-transparent mix-blend-multiply"></div>
        {/* Vertical lines */}
