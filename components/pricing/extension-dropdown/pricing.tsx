...
export default function ExtensionDropdownPricing({
  ...
  const aggregatedExtensionsPriceTier3 = AppConfig.shop.prices.extensions._shared.yearly.tier3 * extensions.length
  const aggregatedExtensionsPriceTier4 = AppConfig.shop.prices.extensions._shared.yearly.tier4 * extensions.length
