...
export default function Pricing() {
  ...
  return (
    <div className="relative">
      ...
      {/* Content */}
      <div className="grid md:grid-cols-5 xl:-mx-6 text-sm [&>div:nth-of-type(-n+5)]:py-6 [&>div:nth-last-of-type(-n+5)]:pb-6 max-md:[&>div:nth-last-of-type(-n+5)]:mb-8 max-md:[&>div:nth-of-type(-n+5):nth-of-type(n+1)]:rounded-t-3xl max-md:[&>div:nth-last-of-type(-n+5)]:rounded-b-3xl md:[&>div:nth-of-type(2)]:rounded-tl-3xl md:[&>div:nth-of-type(5)]:rounded-tr-3xl md:[&>div:nth-last-of-type(4)]:rounded-bl-3xl md:[&>div:nth-last-of-type(1)]:rounded-br-3xl [&>div]:bg-slate-700/20 [&>div:nth-of-type(5n+1)]:bg-transparent [&>div:nth-of-type(-n+5)]:bg-slate-700 [&>div]:-z-50 [&>div:nth-of-type(-n+5)]:-z20 [&>div:nth-of-type(-n+5):nth-of-type(5n+4)]:-z30 max-md:[&>div:nth-of-type(5n+6)]:hidden max-md:[&>div:nth-of-type(5n+2)]:order-1 max-md:[&>div:nth-of-type(5n+3)]:order-2 max-md:[&>div:nth-of-type(5n+4)]:order-3 max-md:[&>div:nth-of-type(5n+5)]:order-4 max-md:md:[&>div:nth-of-type(n)]:mb-0 [&>div:nth-of-type(5n+4)]:sticky [&>div:nth-of-type(5n+4)]:-z-20 before:[&>div:nth-of-type(5n+4)]:absolute before:[&>div:nth-of-type(5n+4)]:-inset-px before:[&>div:nth-of-type(5n+4)]:rounded-[inherit] before:[&>div:nth-of-type(5n+4)]:border-x-2 [&>div:nth-of-type(5n+3)]:sticky [&>div:nth-of-type(5n+3)]:-z-30 before:[&>div:nth-of-type(5n+3)]:absolute before:[&>div:nth-of-type(5n+3)]:-inset-px before:[&>div:nth-of-type(5n+3)]:rounded-[inherit] before:[&>div:nth-of-type(5n+3)]:border-x-2 [&>div:nth-of-type(5n+5)]:sticky [&>div:nth-of-type(5n+5)]:-z-30 before:[&>div:nth-of-type(5n+5)]:absolute before:[&>div:nth-of-type(5n+5)]:-inset-px before:[&>div:nth-of-type(5n+5)]:rounded-[inherit] before:[&>div:nth-of-type(5n+5)]:border-x-2 before:[&>div:nth-of-type(4)]:border-t-2 before:[&>div:nth-of-type(3)]:border-t-2 before:[&>div:nth-of-type(5)]:border-t-2 before:[&>div:nth-last-of-type(1)]:border-b-2 before:[&>div:nth-last-of-type(2)]:border-b-2 before:[&>div:nth-last-of-type(3)]:border-b-2 before:[&>div:nth-of-type(5n+3)]:border-slate-700 before:[&>div:nth-of-type(5n+3)]:-z-30 before:[&>div:nth-of-type(5n+3)]:pointer-events-none before:[&>div:nth-of-type(5n+5)]:border-slate-700 before:[&>div:nth-of-type(5n+5)]:-z-30 before:[&>div:nth-of-type(5n+5)]:pointer-events-none before:[&>div:nth-of-type(5n+4)]:border-purple-500 before:[&>div:nth-of-type(5n+4)]:-z-20 before:[&>div:nth-of-type(5n+4)]:pointer-events-none">
        {/* Pricing toggle */}
