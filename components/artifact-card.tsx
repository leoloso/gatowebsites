...
export default function ArtifactCard({
  ...
  return (
    <div className="bg-gradient-to-tr from-slate-800 to-purple-800/25 rounded-3xl border border-slate-800 hover:border-slate-700/60 transition-colors group relative">
