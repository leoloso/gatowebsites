...
export default function DemoPostThumb({
  ...
  return (
    <div
      className={clsx("relative bg-gradient-to-tr from-blue-900 to-purple-800 h-full z-20 overflow-hidden", paddingClassname, isLandscape && "aspect-video")}
      // data-aos="zoom-out"
    >
      ...
      <div className="w-full h-full aspect-video flex items-center justify-center">
        ...
        <div className={clsx("flex items-center justify-center", !isLandscape && "flex-col")}>
          ...
          <div className={clsx("flex", !isLandscape &&  "gap-3 sm:gap-6 md:gap-12 lg:gap-24 mt-2 md:mt-4", isLandscape &&  "flex-col gap-2 sm:gap-3 md:gap-6 lg:gap-12 ml-2 md:ml-4")}>
