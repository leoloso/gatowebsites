    ...
    <div className="flex items-center justify-center">
        <div>
            <div className="grid w-full place-items-center overflow-x-scroll rounded-lg p-6 lg:overflow-visible">
                <div role="alert" className="relative block w-full text-base font-regular px-4 py-4 rounded-lg bg-gradient-to-tr from-orange-500 to-red-500 text-white flex">
                    <div className="">
