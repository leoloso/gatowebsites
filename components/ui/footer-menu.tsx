    ...
    <>
      ...
      <div className={columnClassname}>
        ...
        <ul className="text-sm space-y-2">
          ...
          <li>
            <a className="text-slate-500 dark:text-slate-400 hover:text-slate-800 dark:hover:text-slate-200 transition duration-150 ease-in-out" href="/gatographql-vs-wprestapi">Gato GraphQL vs WP REST API</a>
          </li>
          <li>
