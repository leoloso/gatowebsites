      ...
      <nav className="hidden md:flex md:grow">
        ...
        <ul className="flex grow justify-center flex-wrap items-center">
          ...
          <Dropdown title="Documentation">
            {/* 2nd level: hover */}
            <li>
              <Link className="font-medium text-sm text-slate-300 hover:text-white mx-4 lg:mx-5 transition duration-150 ease-in-out" href={`/${AppConfig.paths.guides}`}>Guides</Link>
            </li>
          </Dropdown>
        </ul>
      </nav>
