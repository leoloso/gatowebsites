    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          {/* CTA box */}
          <div className="relative bg-gradient-to-b from-cyan-800 to-transparent opacity-25 dark:opacity-100 h-[24rem] dark:h-auto dark:bg-purple-900/70 dark:bg-none rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
