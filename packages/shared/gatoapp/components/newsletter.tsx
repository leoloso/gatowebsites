    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pb-12 md:pb-20">
          ...
          {/* CTA box */}
          <div className="relative bg-gradient-to-b from-slate-800 to-transparent opacity-25 h-[25rem] dark:bg-purple-900/70 rounded py-10 px-8 md:py-16 md:px-12 shadow-2xl overflow-hidden" data-aos="zoom-y-out">
