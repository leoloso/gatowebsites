...
export default function Thumb({
  ...
  return (
    <div
      className={clsx("relative w-full h-full z-20 overflow-hidden", bgClassname, !bgClassname && isDarkColorThemeMode && "bg-gradient-to-tr from-slate-900 to-violet-900", !bgClassname && !isDarkColorThemeMode && "bg-gradient-to-tr from-blue-400 to-violet-500 text-indigo-100", paddingClassname, extraThumbClassname)}
    >
