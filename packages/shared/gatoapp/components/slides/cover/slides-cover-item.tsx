...
export default function SlidesCoverItem({
  ...
  return (
    ...
    >
      <Thumb
        bgClassname={bgClassname || clsx('bg-gradient-to-tr', isDarkColorThemeMode && 'from-slate-900 to-blue-900', !isDarkColorThemeMode && 'from-teal-600 to-violet-600 text-indigo-100')}
        numberParticles={20}
      >
