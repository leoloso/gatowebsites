      ...
      {prevArticle &&
        <div className="sm:w-1/2 sm:flex flex-col items-start">
          <div>
            ...
            <div>
              <Link className="text-slate-800 font-[650] flex items-center dark:text-slate-200" href={prevArticle.urlPath}>
      ...
      {nextArticle &&
        <div className="sm:w-1/2 sm:flex flex-col items-end ml-auto mt-2 sm:mt-0">
          <div>
            ...
            <div>
              <Link className="text-slate-800 font-[650] flex items-center dark:text-slate-200" href={nextArticle.urlPath}>
