    ...
    >
      <div className="flex flex-col sm:flex-row justify-center max-w-xs mx-auto sm:max-w-md lg:mx-0">
        <input
          ...
          type="email"
          className="form-input w-full appearance-none bg-teal-800 dark:bg-purple-800 border border-teal-700 dark:border-purple-700 focus:border-teal-600 dark:focus:border-purple-600 rounded-sm px-4 py-3 mb-2 sm:mb-0 sm:mr-2 text-white placeholder-teal-500 dark:placeholder-purple-500"
      ...
      <p className="text-sm text-teal-300 dark:text-purple-400 mt-3">No spam. You can unsubscribe at any time.</p>
    </form>
  )
}
