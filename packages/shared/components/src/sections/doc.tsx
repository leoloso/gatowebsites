import { DocMdx } from '@gato/components/src/mdx/doc-mdx'
import TopicTitle from '@gato/components/src/ui/docs/topic-title'
import Hamburger from '@gato/components/src/ui/docs/hamburger'
// import Feedback from '@gato/components/src/ui/feedback'
import ArticleNavigation from '@gato/components/src/ui/article-navigation'
import Footer from '@gato/components/src/ui/docs/footer'
import SecondaryNav from '@gato/components/src/ui/docs/secondary-nav'
