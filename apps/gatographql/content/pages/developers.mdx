...
description: Join the program to create commercial extensions for Gato GraphQL
...
The Gato GraphQL plugin can be augmented via [extensions](/extensions), which add more functionality and extend the GraphQL schema.
...
Yes, you can also be an [affiliate](https://shop.gatographql.com/affiliates). When getting a customer for Gato GraphQL, you will then get the affiliate commission, plus the profits from your extension.
