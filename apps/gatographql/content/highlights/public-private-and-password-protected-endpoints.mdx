...
videoDesc: We create a custom endpoint and make it password-protected. When accessing its GraphiQL client, a prompt requests the password. Only after the password has been provided can the GraphiQL client, and the GraphQL endpoint, be accessed.
---
