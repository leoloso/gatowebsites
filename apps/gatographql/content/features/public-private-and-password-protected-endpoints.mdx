...
description: In addition to creating and exposing public endpoints, create private endpoints, and protect a public endpoint with a password.
# category: PRO plugin
# category: Standard
order: 164
relatedGuides: [
  {
    topic: code,
    slug: exposing-public-and-private-endpoints
  },
]
---
