...
Schema introspection is GraphQL's mechanism to provide information about the schema, which is retrieved using the same GraphQL language. It is thanks to introspection that clients such as [GraphiQL](/guides/intro/intro-to-the-graphiql-client) and [GraphQL Voyager](/guides/intro/intro-to-the-voyager-client) can help us interact with the GraphQL schema.
