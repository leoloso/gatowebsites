---
title: Translate posts for MultilingualPress (Gutenberg)
description: Translate a block-based post to all languages as defined in MultilingualPress, and store those translations in the corresponding sites in the network
order: 0
---

This GraphQL query is an integration for the <a href="https://multilingualpress.org/" target="_blank">MultilingualPress</a> plugin, to translate posts based on the Gutenberg editor.
...
# to translate posts based on the Gutenberg editor, where every site in a
