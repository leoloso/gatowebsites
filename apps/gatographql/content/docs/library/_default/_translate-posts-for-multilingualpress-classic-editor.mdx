...
description: Translate a Classic editor post to all languages as defined in MultilingualPress, and store those translations in the corresponding sites in the network
order: 0
---
