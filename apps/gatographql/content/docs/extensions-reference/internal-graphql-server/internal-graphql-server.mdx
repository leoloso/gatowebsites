...
order: 2000
# shopProductTestModeURL: https://shop.gatographql.com/buy/a4f45a5c-d318-442a-929e-0feb2109cb33
# shopProductURL: https://shop.gatographql.com/buy/ca6a4ed8-78e8-4d29-bb59-1b93471f9b1e
# productPrices:
# - 24.99
# - 49.99
# - 99.99
...
The internal GraphQL Server applies its own Schema Configuration. For instance, the default one is selected in the Settings page, under tab "Internal GraphQL Server".

![Configuring the Internal GraphQL Server in the Settings](/assets/guides/upstream-pro/settings-schema-configuration-for-internal-graphql-server.png)
...
To illustrate, let's say that we have configured the single endpoint `graphql/` to apply an Access Control List to validate users by IP, and we execute mutation `createPost` against this endpoint:
