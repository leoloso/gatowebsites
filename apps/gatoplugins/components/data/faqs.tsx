  ...
  if (plugin.slug === 'multilingual-polylang') {
    return [    
      ...
      },
      {
        ...
        answer: <span>If you purchased a Gato GraphQL product and it does not solve your problem, you have 30 days to <a className="text-blue-500 font-medium hover:underline" href="/refund-policy">request a refund</a>.</span>,
        column: 1,
      },
      {
      ...
      },
      {
        ...
        answer: <span>Check out the <a className="text-blue-500 font-medium hover:underline" href="/comparisons/gatographql-vs-wp-rest-api">Gato GraphQL vs WP REST API comparison</a>.</span>,
        column: 1,
      },
      {
      ...
      },
      {
        ...
        answer: <span>Check out the <a className="text-blue-500 font-medium hover:underline" href="/comparisons/gatographql-vs-wpgraphql">Gato GraphQL vs WPGraphQL comparison</a>.</span>,
        column: 2,
      },
    ]
  }
