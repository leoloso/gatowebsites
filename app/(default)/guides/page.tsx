          ...
          <div className="pt-32 pb-12 md:pt-40 md:pb-20">
            ...
            <div className="pb-12 md:pb-20">
              <article className="max-w-sm mx-auto md:max-w-none grid md:grid-cols-2 gap-6 md:gap-8 lg:gap-12 xl:gap-16 items-center">
                <Link href={`/guides/${featuredPost.slug}`} className="relative block group" data-aos="fade-right" data-aos-delay="200">
                ...
                <div data-aos="fade-left" data-aos-delay="200">
                  <header>
                    ...
                    <h3 className="h3 text-2xl lg:text-3xl mb-2">
                      <Link href={`/guides/${featuredPost.slug}`} className="hover:text-gray-100 transition duration-150 ease-in-out">{featuredPost.title}</Link>
                    </h3>
                  </header>
