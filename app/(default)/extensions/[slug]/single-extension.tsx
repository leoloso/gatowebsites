    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6">
      ...
      <div className="pb-12 md:pb-20">
        <div className="mb-8 text-center">
          ...
          <p className="text-lg text-slate-400">Purchase the <span className='font-bold'>{ extension.title }</span> extension, or get a bundle with all the extensions, with a big discount.</p>
        </div>
