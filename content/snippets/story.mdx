...
Indeed, **Gato GraphQL was designed to help manage the WordPress site**. It can retrieve any piece of data, transform the data in any desired way, and store the data again to the DB, or execute some operation with it.
...
Gato GraphQL is based on the beautiful city of Kuala Lumpur, in Malaysia.
