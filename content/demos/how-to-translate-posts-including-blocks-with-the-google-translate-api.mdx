---
title: 'How to translate posts including blocks with the Google Translate API'
seoTitle: 'How to translate WordPress posts with Gutenberg blocks via the Google Translate API using Gato GraphQL'
publishedAt: '2024-04-04'
image: '/images/thumbnails/demos/gatographql-google-translate-wordpress.png'
leading: Gato GraphQL translation demo
description: 'Translate a post to the desired language, with full support for (Gutenberg) blocks, by connecting to the Google Translate API.'
seoDescription: 'Translate a WordPress post to the desired language using Gato GraphQL, with full support for Gutenberg blocks, by connecting to the Google Translate API.'
...
- `toLang`: the [language code](/extensions-reference/google-translate#list-of-languages) to translate to
