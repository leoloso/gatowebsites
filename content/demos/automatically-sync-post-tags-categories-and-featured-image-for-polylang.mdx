...
This demo is a continuation of **[Automatically translating posts for Polylang](/demos/automatically-translate-posts-for-polylang-gutenberg)**, to also synchronize the translations for the tags, categories, and featured image for a post.
