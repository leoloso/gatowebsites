...
Gato GraphQL already ships with this persisted query, under title **Export post to WordPress site**
...
Gato GraphQL already ships with this persisted query, under title **Import post from WordPress site**
