...
- The temporary site (`translation-es.instawp.xyz`), for the translator to fix the translation
- The translated site (`content-es.instawp.xyz`), containing the content in Spanish

Publish your blog post in your WordPress site and, depending on using the Gutenberg editor or the Classic editor, translate it to the desired language using Gato GraphQL + Google Translate, as explained in demos:
...
The origin site will now contain the translated post as a duplicate from the original. Synchronize it to the 
