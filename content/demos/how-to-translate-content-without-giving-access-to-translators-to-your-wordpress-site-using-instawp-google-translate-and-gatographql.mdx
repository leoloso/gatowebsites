...
The **origin site** will now contain the Google-Translated post as a duplicate from the original, with `draft` status. Synchronize it to the **provisional site**, using the following GraphQL query:
...
And provide the JSON dictionary with the needed GraphQL variables:
