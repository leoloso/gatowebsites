...
Publish the blog post in your origin WordPress site, and translate it to the desired language using Gato GraphQL + Google Translate, as explained in demos:
...
Execute it, providing the JSON dictionary with the needed GraphQL variables:
