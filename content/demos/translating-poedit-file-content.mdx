...
description: 'Translate all the empty strings in a Poedit file from your themes and plugins to any language, and store the new translated Poedit file in Filestack (from where you can download it).'
seoDescription: 'Translate all the empty strings in a Poedit file from your themes and plugins to any language, and store the new translated Poedit file in Filestack (from where you can download it), by using Gato GraphQL and connecting to the Google Translate API.'
