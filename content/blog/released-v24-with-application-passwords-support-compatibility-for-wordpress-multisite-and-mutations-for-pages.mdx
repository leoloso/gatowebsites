---
title: "⭐️ Released v2.4 with Application Passwords support, compatibility with WordPress multisite, and mutations for pages"
description: 'Gato GraphQL v2.4 has been released with several improvements and bug fixes'
publishedAt: '2024-06-01 08:00:00'
...
Check the video for demo [Translating pages on a Multilingual site based on WordPress Multisite](/demos/translating-pages-on-a-multilingual-wordress-site), where Gato GraphQL helps translate all pages in a multilingual site based on a WordPress Multisite network:
