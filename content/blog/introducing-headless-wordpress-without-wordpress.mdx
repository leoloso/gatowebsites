...
The locations of the artifacts from the GraphQL response are then injected into WP-CLI, as to have the plugins automatically installed in my local DEV webserver, to run tests.
...
I'll explain a bit more in detail how that GraphQL query works later on in this post.
