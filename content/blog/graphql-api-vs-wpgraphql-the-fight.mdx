...
(In the meantime, I should display an ad from [my sponsors](https://github.com/sponsors/leoloso/). Unfortunately, I don't have any yet. If you'd like your company to fund development of the GraphQL API for WordPress, and get exposure in prime media like this event, [send me a message](/contact/).)
...
Which brings us to the GraphQL API for WordPress. It not only [offers persisted queries](/features/persisted-queries), but has strived to make it a central part of the offering:
...
Or will you give the GraphQL API for WordPress the opportunity it is claiming for, [download the plugin](/download), and give it a try?
