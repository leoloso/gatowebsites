...
That is the case with Gato GraphQL.
...
Then your plugin can access data via the [internal `blockEditor` endpoint](/guides/code/feeding-data-to-blocks-in-the-editor):
