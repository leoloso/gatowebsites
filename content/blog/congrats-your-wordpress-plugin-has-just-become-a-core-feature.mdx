...
Let's consider this issue whenever Gato GraphQL is the plugin dependency.
...
This situation could also be improved, and even completely avoided. For instance, Gato GraphQL could release a **Lite** version plugin, which simply installs a GraphQL server for internal consumption only, not visible through the UI. (Another tasks for my TODO list!)
