...
After updating the plugin (i.e. not installing anew), you need to deactivate and then re-activate the plugin, otherwise the "GraphiQL" and "Schema" items won't appear on the menu.
