...
Gato GraphQL `v6.0` has been released. Check out the [release notes in GitHub](https://github.com/GatoGraphQL/GatoGraphQL/releases/tag/5.0.0) for the complete list of changes.
