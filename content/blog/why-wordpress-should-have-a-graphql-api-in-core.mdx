...
(Btw, this is the GraphiQL client. [Here is a tutorial](https://gatographql.com/guides/intro/intro-to-the-graphiql-client/) on using it.)
...
The first one is to use the [multiple-query execution](https://gatographql.com/guides/special-features/multiple-query-execution/) feature.
...
More elegant still, we can use [nested mutations](https://gatographql.com/guides/special-features/nested-mutations/).
