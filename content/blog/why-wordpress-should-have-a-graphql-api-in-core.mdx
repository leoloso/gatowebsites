...
The first one is to use the [multiple-query execution](https://gatographql.com/features/multiple-query-execution/) feature.
...
More elegant still, we can use [nested mutations](https://gatographql.com/features/nested-mutations/).
