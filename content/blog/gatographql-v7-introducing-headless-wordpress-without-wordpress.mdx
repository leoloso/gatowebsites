...
Check out the video (at the end of this post), with a demonstration of using GraphQL to interact with GitHub's API, to install artifacts in a development webserver.
