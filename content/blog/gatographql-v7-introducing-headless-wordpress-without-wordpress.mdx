...
Then, for each of the REST endpoints in your application, you can create a corresponding persisted query endpoint, and inject those URLs in your app.
...
Thanks to the API hierarchy, the persisted query be published under path `/graphql-query/wp/v2/posts/`, making it easy to replace endpoints.
