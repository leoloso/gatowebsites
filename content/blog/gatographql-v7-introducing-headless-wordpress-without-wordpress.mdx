...
Ever since the Matt Mullenweg vs WPEngine debacle, I've noticed more and more people in Reddit asking for alternatives to WordPress. This is not necessarily because they want to switch away from WordPress, most likely not immediately at least, but to know how they can switch away from it if they have to, and how painful would that be. They are hedging their bets.

It is to address this concern that Gato GraphQL now provides a cool new feature: **Headless WordPress without WordPress**.
