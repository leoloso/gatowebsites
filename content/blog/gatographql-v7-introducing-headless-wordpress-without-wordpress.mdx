...
There are several examples of adapting queries in [`leoloso/next-wordpress-starter`](https://github.com/leoloso/next-wordpress-starter). For instance, [this WPGraphQL query](https://github.com/leoloso/next-wordpress-starter/blob/main/src/data/providers/wpgraphql/posts.js#L3):
