...
## You are doing headless WordPress with another API

If you are already doing headless WordPress, chances are that your application is using another API, either the WP REST API or WPGraphQL.

Well, good news is that it is possible to have Gato GraphQL take their place with relatively little pain.
