...
Gato GraphQL `v3.0` has been released, containing new features and a couple of breaking changes. Check out the [release notes in GitHub](https://github.com/GatoGraphQL/GatoGraphQL/releases/tag/3.0.0).

These are the updates.

## Breaking change: Require at least WordPress v6.0

When using Gato GraphQL with WordPress `v6.6`, [blocks in the plugin stopped working](https://github.com/WordPress/gutenberg/issues/63009).
...
## Breaking change: Option "Do not use payload types for mutations (i.e. return the mutated entity)" in schema configuration block "Payload Types for Mutations" must be re-selected
...
## Added fields to query the mutation payload objects
...
## Added option to schema configuration block "Payload Types for Mutations"
...
## Added predefined custom endpoint "Bulk mutations"
...
## Removed predefined custom endpoint "Nested mutations + Entity as mutation payload type"
...
- Catch exception if dependency version is not semver
