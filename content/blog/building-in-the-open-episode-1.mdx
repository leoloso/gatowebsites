...
If you notice the [Guides](/guides/), section "Extending the GraphQL API" is still pretty empty:
...
[🥊 GraphQL API vs WPGraphQL: the fight!](/blog/graphql-api-vs-wpgraphql-the-fight/) compares my plugin with [WPGraphQL](https://www.wpgraphql.com/), on a clash to be remembered for ages to come, and which will keep boxing fans asking for more.
...
[🍾 GraphQL API for WordPress is now scoped, thanks to PHP-Scoper!](/blog/graphql-api-for-wp-is-now-scoped-thanks-to-php-scoper/) describes a strategy to scope a WordPress plugin using [PHP-Scoper](https://github.com/humbug/php-scoper), as to avoid conflicts with other plugins.
