...
Last week I published article [💁🏻‍♀️ Why the GraphQL API needs a Monorepo, and How it's optimized](/blog/extending-the-monorepo-builder/), explaining how and why the `GatoGraphQL/GatoGraphQL` monorepo, which hosts the code for Gato GraphQL, can manage the plugin's codebase efficiently.
...
3. [Gato GraphQL](https://gatographql.com)
