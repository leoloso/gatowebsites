...
description: Store GraphQL queries in the server via a user interface, and access them under their own URL, thus emulating a REST endpoint.
# category: PRO plugin
category: Standard
order: 50
relatedGuide: {
  topic: use,
  slug: creating-a-persisted-query
}
---
