...
# isPRO: true
description: Multiple queries are combined into a single one, sharing state across them, and executing them together in a single request for better performance.
category: PRO plugin
order: 200
relatedGuide: {
  topic: schema,
