...
description: Tackle admin tasks that are common to WordPress sites, by executing an already-installed persisted query.
category: Free plugin
# image: /assets/GatoGraphQL-logo-suki.png
order: 56
---

[Persisted queries](/features/persisted-queries) are composed, stored and executed already within the wp-admin, making it easy for admins to execute and automate tasks on their sites. They are similar to WP-CLI commands, however using GraphQL queries instead.
