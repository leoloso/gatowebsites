...
description: Gato GraphQL supports `@oneOf`, an input object where exactly one of the input fields must be provided, or the server returns a validation error.
