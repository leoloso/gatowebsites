...
# isPRO: true
description: Avoid visitors retrieving private information from your site, by granting granular access to the schema, based on the user being logged-in (or not), having a certain role or capability, and more.
category: PRO plugin
