...
query {
  _httpRequestHeaders
  _httpRequestHeader(name: "Accept")
  _httpRequestHasHeader(name: "Accept")
  _httpRequestBody
  _httpRequestMethod
  _httpRequestDomain
  _httpRequestScheme
  ...
  _httpRequestQuery
  _httpRequestParams
  _httpRequestStringParam(name: "page")
  _httpRequestHasParam(name: "page")
  _httpRequestCookie(name: "wordpress_test_cookie")
  _httpRequestHasCookie(name: "wordpress_test_cookie")
...
```json
{
  "data": {
    ...
    "_httpRequestHeader": "application/json",
    "_httpRequestHasHeader": true,
    ...
    "_httpRequestStringParam": "gatographql",
    "_httpRequestHasParam": true,
    "_httpRequestCookie": "WP Cookie check",
    "_httpRequestHasCookie": true,
