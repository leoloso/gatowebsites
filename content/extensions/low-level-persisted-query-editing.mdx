---
name: Low-Level Persisted Query Editing
...
This extension makes all schema-type directives available in the GraphiQL editor when editing persisted queries, allowing to avoid the user interface and add these directives already in the persisted query.
