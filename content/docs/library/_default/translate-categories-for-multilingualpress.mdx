---
title: Translate categories for MultilingualPress
description: Translate a category to all languages as defined in MultilingualPress, and store those translations in the corresponding sites in the network
order: 0
---

This GraphQL query is an integration for the <a href="https://multilingualpress.org/" target="_blank">MultilingualPress</a> plugin, to translate categories.
...
The query takes an origin category, translates it using the Google Translate API to the other languages defined as connections via MultilingualPress, and stores those translations in the corresponding sites in the network. All translation categories must already exist.
