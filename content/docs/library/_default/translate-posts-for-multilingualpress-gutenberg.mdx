...
description: Translate a block-based post to all languages defined in the MultilingualPress settings, and store those translations in the corresponding posts
order: 0
---
