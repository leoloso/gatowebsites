---
title: Sync tags and categories for Polylang
description: 'Integration with Polylang: For a given post, update its translation posts with the corresponding tags and categories for each language'
order: 0
---
