---
title: Translate posts for MultilingualPress (Classic editor)
description: Translate a Classic editor post to all languages defined in the MultilingualPress settings, and store those translations in the corresponding posts
order: 0
---

This GraphQL query is an integration for the <a href="https://multilingualpress.org/" target="_blank">MultilingualPress</a> plugin, to translate posts based on the Classic editor.
...
It takes an origin post, it translates it using the Google Translate API to the other languages defined as connections via MultilingualPress, and stores those translations in the corresponding sites in the network. All translation posts must already exist.
