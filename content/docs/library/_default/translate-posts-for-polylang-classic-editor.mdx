...
Integration with the <a href="https://wordpress.org/plugins/polylang/" target="_blank">Polylang</a> plugin (and also **Polylang PRO**).

This GraphQL query is an integration for Polylang, to translate posts based on the Classic editor.
