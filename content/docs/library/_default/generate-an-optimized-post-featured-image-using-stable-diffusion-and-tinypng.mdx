...
It first checks if a post has a featured image. If it does not, it creates one by calling Stable Diffusion's generative AI service. We must provide the API key to use it.
