...
This query requires the endpoint to have [Nested Mutations](/guides/schema/using-nested-mutations) enabled, and [Payload Types for Mutations](/guides/config/returning-a-payload-object-or-the-mutated-entity-for-mutations) with value `"Do not use Payload Types for Mutations (i.e. return the mutated entity)"`.
