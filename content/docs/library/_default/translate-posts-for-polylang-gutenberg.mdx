...
This GraphQL query is an integration for <a href="https://wordpress.org/plugins/polylang/" target="_blank">Polylang</a> plugin (and also **Polylang PRO**), to translate posts based on the Gutenberg editor.
