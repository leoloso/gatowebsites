  ...
  @include(if: $isGutenbergEditorEnabled)
{
  ...
  originPost: post(by: { id: $postId }, status: any) {
    ...
    polylangTranslationLanguageIDs(filter: {
      ...
      @remove
    postIDTranslationLanguageIDs: _echo(value: $__polylangTranslationLanguageIDs)
      @default(value: {})
      @export(as: "postIDTranslationLanguageIDs")

    hasTranslationPosts: _notEmpty(value: $__postIDTranslationLanguageIDs)
      @export(as: "hasTranslationPosts")
...
{
  translationPostIds: _objectValues(object: $postIDTranslationLanguageIDs)
    @export(as: "translationPostIds")
  emptyTranslationPostVars: posts(filter: { ids: $__translationPostIds, status: $statusToUpdate } ) {
    id
    emptyArray: _echo(value: [])
      @export(
        as: "rawTitle"
