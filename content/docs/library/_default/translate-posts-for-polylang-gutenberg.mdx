---
title: Translate posts for Polylang (Gutenberg)
description: Translate a block-based post to all languages defined in the Polylang settings, and store those translations in the corresponding posts
order: 0
---

This GraphQL query is an integration for the <a href="https://wordpress.org/plugins/polylang/" target="_blank">Polylang</a> plugin (and also **Polylang PRO**), to translate posts based on the Gutenberg editor.
  ...
  @configureWarningsOnExportingDuplicateVariable(enabled: false)
{
  ...
  emptyArray: _echo(value: [])
    ...
    @export(as: "originCoreQuoteValueItems")
    @export(as: "originCoreQuoteValueReplacementsFrom")
    @export(as: "originCoreQuoteValueReplacementsTo")
  ...
  @include(if: $executeTranslation)
{
  posts(filter: { ids: $translationPostIds, status: $statusToUpdate } ) {
    ...
    coreQuoteValueItems: _echo(value: $originCoreQuoteValueItems)
      @export(
        as: "coreQuoteValueItems"
        type: DICTIONARY
      )
    ...
    coreQuoteValueReplacementsFrom: _echo(value: $originCoreQuoteValueReplacementsFrom)
      @export(
        as: "coreQuoteValueReplacementsFrom"
        type: DICTIONARY
      )
    ...
    coreQuoteValueReplacementsTo: _echo(value: $originCoreQuoteValueReplacementsTo)
      @export(
        as: "coreQuoteValueReplacementsTo"
        type: DICTIONARY
      )
