---
title: "Sync the post's featured image for Polylang"
description: 'Integration with Polylang: For a given post, update its translation posts with the corresponding featured image for each language'
order: 0
---

This GraphQL query is an integration for the <a href="https://wordpress.org/plugins/polylang/" target="_blank">Polylang</a> plugin (and also **Polylang PRO**).
