...
The GraphQL schema can be configured with those elements provided by the different installed and enabled modules. (Go to the [Modules page](/guides/config/browsing-enabling-and-disabling-modules) to see the list of all of them.)
...
- Define [who can access the schema via Access Control Lists](/guides/use/defining-access-control)
- Set-up [HTTP caching via Cache Control Lists](/guides/use/adding-http-caching)
- Many others

![Schema Configuration](/assets/guides/upstream/schema-configuration.png "Schema Configuration")
...
{/* <Image
  src=/assets/guides/upstream/schema-configurations-page.png
  width="1024"
  height="940"
  alt=Schema Configurations in the admin
  caption=Schema Configurations in the admin
/> */}

![Schema Configurations in the admin](/assets/guides/upstream/schema-configurations-page.png)
...
{/* <Image
  src=/assets/guides/upstream/new-schema-configuration.png
  width="1024"
  height="940"
  alt=Creating a new Schema Configuration
  caption=Creating a new Schema Configuration
/> */}

![Creating a new Schema Configuration](/assets/guides/upstream/new-schema-configuration.png)
...
![Creating a new schema configuration](/assets/guides/upstream/editing-schema-configuration.gif)
...
![Selecting the Schema Configuration in the Custom Endpoint](/assets/guides/upstream/schema-configuration-in-custom-endpoint.png "Selecting the Schema Configuration in the Custom Endpoint")
...
![Schema configuration's source](/assets/guides/upstream/schema-configuration-source.png "Schema configuration's source")
