...
![Custom Endpoints in the admin](/assets/guides/upstream/custom-endpoints-page.png)
...
![Custom endpoint's link to the GraphiQL client in the list](/assets/guides/upstream/custom-endpoints-actions-graphiql.png)
...
![Custom endpoint's link to the Interactive Schema client in the list](/assets/guides/upstream/custom-endpoints-actions-interactive-schema.png)
