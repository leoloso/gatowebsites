...
![Access Control Lists in the admin](/assets/guides/upstream-pro/access-control-lists.png "Access Control Lists in the admin")
...
![Selecting an Access Control List in the Schema Configuration](/assets/guides/upstream-pro/schema-config-access-control-lists.png "Selecting an Access Control List in the Schema Configuration")
