...
![Persisted Queries in the admin](/assets/guides/upstream/persisted-queries-page.png)
...
![Persisted query Settings](/assets/guides/upstream/settings-persisted-queries.png)
