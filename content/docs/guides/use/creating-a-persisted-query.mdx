...
![Persisted Queries in the admin](/assets/guides/upstream/persisted-queries-page.png "Persisted Queries in the admin")
...
![Persisted query Settings](/assets/guides/upstream/settings-persisted-queries.png "Persisted query Settings")
