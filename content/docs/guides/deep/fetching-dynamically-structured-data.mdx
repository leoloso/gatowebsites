...
{/* <Image
  ...
  width="1024"
  height="940"
  alt=Adding options to the allowlist in the Settings page
  caption=Adding options to the allowlist in the Settings page
/> */}

![Adding options to the allowlist in the Settings page](/assets/guides/upstream/settings-settings-entries.png)
