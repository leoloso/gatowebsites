...
![Providing Response Headers in the Schema Configuration](/assets/guides/upstream/schema-configuration-response-headers.png "Providing Response Headers in the Schema Configuration")
...
![Providing Response Headers in the Settings](/assets/guides/upstream/settings-response-headers.png "Providing Response Headers in the Settings")
