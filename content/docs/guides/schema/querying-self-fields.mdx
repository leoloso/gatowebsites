...
![Setting self fields for the schema configuration, in the Settings](/assets/guides/upstream/settings-self-fields-default.png "Setting self fields for the schema configuration, in the Settings")
