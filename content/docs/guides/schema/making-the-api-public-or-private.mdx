...
![Public/Private schema mode, set in the Schema configuration](/assets/guides/upstream-pro/schema-configuration-public-private-schema-mode.png "Public/Private schema mode, set in the Schema configuration")
...
![Defaul Public/Private schema mode](/assets/guides/upstream-pro/default-public-private-schema-mode.png "Defaul Public/Private schema mode")
