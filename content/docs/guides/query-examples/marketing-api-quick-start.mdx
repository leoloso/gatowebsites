...
description: "This guide will give you everything you need to start using the Docs Marketing API to manage audiences, control automation workflows, sync email activity with your database, and more."
order: 300
---
...
<ModalVideo
  thumb="/assets/theme/content-image-01.jpg"
  thumbWidth={680}
  thumbHeight={382}
  thumbAlt="Modal video thumbnail"
  video="/temporary/videos/video.mp4"
  videoWidth={1920}
  videoHeight={1080} />
...
<Image
  src="/assets/theme/content-image-02.jpg"
  width="680"
  height="382"
  alt="News inner"
/>
