...
Alternatively, you can create Persisted Queries and retrieve data from them (instead of from an endpoint). Check out how the [client code must be adapted](/guides/intro/connecting-to-the-graphql-server-from-a-client#executing-persisted-queries).
