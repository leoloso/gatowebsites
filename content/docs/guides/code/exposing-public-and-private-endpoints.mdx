---
title: Exposing public and private endpoints [PRO]
...
The [single endpoint](/guides/config/enabling-and-configuring-the-single-endpoint) is always public, exposed by default under `/graphql`.
