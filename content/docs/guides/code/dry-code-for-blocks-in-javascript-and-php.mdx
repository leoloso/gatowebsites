---
title: Using DRY code to render blocks for server (PHP) and client (JS) sides [PRO]
...
The **[Internal GraphQL Server](/extensions-reference/internal-graphql-server)** extension installs a server that can be invoked within our application, using PHP code.
