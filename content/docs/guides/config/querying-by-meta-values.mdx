...
![Defining the entries in the Schema Configuration](/assets/guides/upstream/schema-configuration-custompost-meta-entries.png "Defining the entries in the Schema Configuration")
...
![Defining the entries in the Settings](/assets/guides/upstream/settings-custompost-meta-entries.png)
...
{/* <Image
  src=/assets/guides/upstream/schema-configuration-custompost-meta-behavior.png
  width="1024"
  height="940"
...
![Defining the access behavior](/assets/guides/upstream/schema-configuration-custompost-meta-behavior.png)
