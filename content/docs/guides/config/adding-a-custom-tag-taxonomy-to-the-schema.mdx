...
{/* <Image
  src=/assets/guides/upstream/tags-settings-queryable-taxonomies.png
  width="1024"
  height="940"
  alt=Selecting the allowed tag taxonomies in the Settings
  caption=Selecting the allowed tag taxonomies in the Settings
/> */}

![Selecting the allowed tag taxonomies in the Settings](/assets/guides/upstream/tags-settings-queryable-taxonomies.png)
