...
![Single endpoint's link to the GraphiQL client](/assets/guides/upstream/single-endpoint-graphiql-link.png "Single endpoint's link to the GraphiQL client")
...
![Path to GraphiQL client](/assets/guides/upstream/settings-graphiql-for-single-endpoint.png "Path to GraphiQL client")
