...
![Modules](/assets/guides/downstream/modules.png "Modules")
...
![Enabling a module](/assets/guides/downstream/enabling-module.gif "Enabling a module")
...
![Disabling modules in bulk](/assets/guides/downstream/disabling-modules-in-bulk.gif "Disabling modules in bulk")
...
- Custom private endpoints (also used to feed data to blocks, but allowing you to lock its configuration via PHP hooks)
...
![Disabling modules in bulk](/assets/guides/downstream/disabling-modules-in-private-endpoints.png "Disabling modules in bulk")
...
![Module dependencies](/assets/guides/downstream/module-dependencies.png "Module dependencies")
...
![Filtering modules](/assets/guides/downstream/filtering-modules.gif "Filtering modules")
...
![Viewing module documentation](/assets/guides/downstream/viewing-module-documentation.gif "Viewing module documentation")
...
![Accessing a module's settings](/assets/guides/downstream/accessing-module-settings.gif "Accessing a module's settings")
