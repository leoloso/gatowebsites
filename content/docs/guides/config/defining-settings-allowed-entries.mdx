...
![Defining the entries for the Schema Configuration](/assets/guides/upstream/schema-configuration-settings-entries.png "Defining the entries for the Schema Configuration")

Otherwise, the entries defined in the "Settings" tab from the Settings will be used:

{/* <Image
  src=/assets/guides/upstream/settings-settings-entries.png
  width="1024"
  height="940"
  alt=Defining the entries in the Settings
  caption=Defining the entries in the Settings
/> */}

![Defining the entries in the Settings](/assets/guides/upstream/settings-settings-entries.png)
...
{/* <Image
  src=/assets/guides/upstream/schema-configuration-settings-behavior.png
  width="1024"
  height="940"
...
![Defining the access behavior](/assets/guides/upstream/schema-configuration-settings-behavior.png)
