---
title: Removing fields and directives from the schema [PRO]
# isPRO: true
...
To remove fields and directives from the GraphQL schema, create an [Access Control](/guides/use/defining-access-control) entry containing:
