...
![Single endpoint's link to the Voyager client](/assets/guides/upstream/single-endpoint-interactive-schema-link.png "Single endpoint's link to the Voyager client")
...
![Path to Voyager client](/assets/guides/upstream/settings-interactive-schema-for-single-endpoint.png "Path to Voyager client")
