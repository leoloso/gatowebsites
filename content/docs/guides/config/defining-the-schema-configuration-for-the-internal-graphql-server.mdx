...
![Schema configuration for the Internal GraphQL Server in Settings](/assets/guides/upstream-pro/settings-schema-configuration-for-internal-graphql-server.png "Schema configuration for the Internal GraphQL Server in Settings")
