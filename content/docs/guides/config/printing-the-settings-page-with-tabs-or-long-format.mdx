...
![Settings page organized with tabs](/assets/guides/downstream/settings-page-with-tabs.png "Settings page organized with tabs")

We can also organize the Settings in a single long page:

![Settings page in long form](/assets/guides/downstream/settings-page-long-form.png "Settings page in long form")
...
![Option to organize settings by tabs](/assets/guides/downstream/settings-page-use-tabs-option.png "Option to organize settings by tabs")
