...
![Configuring the $_SERVER property name to retrieve the client IP](/assets/guides/upstream-pro/settings-general-client-ip-address-server-property-name.png)
