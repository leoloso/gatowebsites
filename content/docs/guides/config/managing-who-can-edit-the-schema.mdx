...
With the [Schema Editing Access](/extensions-reference/schema-editing-access) extension, we can enable to grant non-admin users access to create and manage endpoints.
...
![Configuring the schema editing access in the Settings](/assets/guides/upstream-pro/settings-schema-editing-access.png)
