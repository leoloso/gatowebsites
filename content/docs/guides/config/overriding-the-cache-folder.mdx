...
1. An environment variable `CONTAINER_CACHE_DIR`
2. Defining constant `GATOGRAPHQL_CONTAINER_CACHE_DIR` in `wp-config.php`:

```php
// File wp-config.php
define( 'GATOGRAPHQL_CONTAINER_CACHE_DIR', '/path/to/cache' );
```
