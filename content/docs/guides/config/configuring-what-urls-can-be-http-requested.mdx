...
![Defining the entries for the Settings](/assets/guides/upstream-pro/http-requests-settings-entries.png)
...
![Defining the access behavior](/assets/guides/upstream-pro/http-requests-settings-behavior.png)
