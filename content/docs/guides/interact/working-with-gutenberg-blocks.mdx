...
{/* <Image
  src=/assets/guides/upstream/settings-blocks-single-type.png
  width="1024"
  height="940"
  alt=Configuring to directly retrieve `GeneralBlock` instead of `BlockUnion`
  caption=Configuring to directly retrieve `GeneralBlock` instead of `BlockUnion`
/> */}

![Configuring to directly retrieve `GeneralBlock` instead of `BlockUnion`](/assets/guides/upstream/settings-blocks-single-type.png)
