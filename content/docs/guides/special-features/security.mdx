...
![Granting access to editing the schema based on the user role](/assets/guides/upstream-pro/settings-schema-editing-access.png "Granting access to editing the schema based on the user role")
