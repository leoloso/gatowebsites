...
title: HTTP Client
# isPRO: true
description: The GraphQL schema is provided with global fields to execute HTTP requests against a webserver and fetch their response.
# image: /assets/GatoGraphQL-logo-suki.png
order: 1000
templateEngineOverride: md
---

📣 **Note:** This feature is unlocked by the [HTTP Client](../../../extensions/http-client/) extension.

The GraphQL schema is provided with global fields to execute HTTP requests against a webserver and fetch their response.

Due to security reasons, the URLs that can be connected to must be explicitly configured (explained in [Configuring what URLs can be HTTP-requested](../../config/configuring-what-urls-can-be-http-requested/)).
