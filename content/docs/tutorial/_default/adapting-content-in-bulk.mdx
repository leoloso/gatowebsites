---
title: Adapting content in bulk
metaDesc: "Tutorial lesson on adapting content in bulk, updating the title, content and excerpt for multiple posts with a single GraphQL request."
