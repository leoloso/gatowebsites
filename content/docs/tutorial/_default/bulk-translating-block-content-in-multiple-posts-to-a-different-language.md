---
title: Bulk translating block content in multiple posts to a different language
metaDesc: "Tutorial lesson for translating multiple posts at once (in bulk), while executing a single call to the Google Translate API containing all text to translate from all the posts."
...
The previous tutorial lesson demonstrated how to translate a post. This lesson is the equivalent but for translating multiple posts at once (in bulk), while executing a single call to the Google Translate API containing all text to translate from all the posts.
