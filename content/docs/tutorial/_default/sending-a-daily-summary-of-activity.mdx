---
title: "Lesson 15: Sending a daily summary of activity"
description: Integrating Gato GraphQL with WP-Cron, as to automate the execution GraphQL queries that perform admin tasks, with some time interval.
...
We can integrate Gato GraphQL with [WP-Cron](https://developer.wordpress.org/plugins/cron/), as to automate the execution GraphQL queries that perform admin tasks, with some time interval. (The **[Automation](/extensions-reference/automation)** extension is required.)
...
{/* <Image
  src=/assets/extensions/upstream-pro/wp-crontrol-entry.png
  width="1024"
  height="940"
  alt=New entry in WP-Crontrol
  caption=New entry in WP-Crontrol
/> */}

![New entry in WP-Crontrol](/assets/extensions/upstream-pro/wp-crontrol-entry.png)
