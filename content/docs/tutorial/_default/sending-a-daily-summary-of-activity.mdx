---
title: Sending a daily summary of activity
metaDesc: Integrating Gato GraphQL with WP-Cron, as to automate the execution GraphQL queries that perform admin tasks, with some time interval.
