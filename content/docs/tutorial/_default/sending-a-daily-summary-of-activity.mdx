---
title: Lesson 1650 - Sending a daily summary of activity
...
We can integrate Gato GraphQL with [WP-Cron](https://developer.wordpress.org/plugins/cron/), as to automate the execution GraphQL queries that perform admin tasks, with some time interval. (The [**Automation**](/extensions/automation/) extension is required.)
