...
metaDesc: Tutorial lesson on updating posts by modifying their (Gutenberg) block's HTML content, useful for adding a block to all posts in the site before a campaign, and removing it right afterwards.
