---
title: "Lesson 1520: Translating block content in a post to a different language"
...
Translation will follow the same idea, applying directive `@strTranslate` (provided by the [**Google Translate**](/extensions/google-translate/) extension) which translates content via the Google Translate API.
