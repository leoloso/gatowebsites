---
title: "Lesson 11: Translating block content in a post to a different language"
description: Tutorial lesson on translating a post to the desired language, with full support for (Gutenberg) blocks.
order: 1520
...
Translation will follow the same idea, applying directive `@strTranslate` (provided by the **[Google Translate](/extensions-reference/google-translate)** extension) which translates content via the Google Translate API.
