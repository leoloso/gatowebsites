---
title: Searching WordPress data
metaDesc: Examples on using Gato GraphQL to search for posts (and also users, comments, and taxonomies) by meta key and value.
