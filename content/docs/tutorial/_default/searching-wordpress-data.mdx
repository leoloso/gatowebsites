...
- Publish them [as `private`](https://gatographql.com/features/public-private-and-password-protected-endpoints/), so that they are available only within the wp-admin, and only to the admin
