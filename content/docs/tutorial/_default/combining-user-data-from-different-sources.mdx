---
title: Combining user data from different sources
metaDesc: Tutorial lesson on combining the data from two or more sources, and then executing some operation with the combined data.
