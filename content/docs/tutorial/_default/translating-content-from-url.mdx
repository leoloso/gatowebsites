---
title: "Lesson 24: Translating content from URL"
description: Combining HTTP requests with calling the Google Translate API, we can translate the content from any URL.
...
We can combine the fields to execute HTTP requests (provided by the **[HTTP Client](/extensions-reference/http-client/)** extension) with directive `@strTranslate` (provided by the [**Google Translate](/extensions-reference/google-translate/)** extension), to translate the content from any URL.
