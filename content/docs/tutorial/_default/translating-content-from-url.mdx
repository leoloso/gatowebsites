---
title: Lesson 2790 - Translating content from URL
...
We can combine the fields to execute HTTP requests (provided by the [**HTTP Client**](/extensions/http-client/) extension) with directive `@strTranslate` (provided by the [**Google Translate**](/extensions/google-translate/) extension), to translate the content from any URL.
