---
title: "Lesson 10: Retrieving structured data from blocks"
description: Tutorial lesson on iterating the (Gutenberg) blocks in the post and extracting the attributes from deep within the block structure, as to unlock these attributes to be fed into any functionality in our site.
order: 1500
