---
title: Lesson 2000 - Automatically adding a mandatory block
...
The [**Internal GraphQL Server**](/extensions/internal-graphql-server/) by default applies the Schema Configuration defined in its own Settings.
...
This PHP code hooks into WordPress action `draft_post` to execute the Persisted Query (via the [**Internal GraphQL Server**](/extensions/internal-graphql-server/) extension):
