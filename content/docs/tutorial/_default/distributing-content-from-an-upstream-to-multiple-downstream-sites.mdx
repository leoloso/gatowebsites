---
title: "Lesson 3800: Distributing content from an upstream to multiple downstream sites"
...
This is possible because of the difference between function fields `_notNull` and `_notEmpty` (provided by the [**PHP Functions via Schema**](/extensions/php-functions-via-schema/) extension):
