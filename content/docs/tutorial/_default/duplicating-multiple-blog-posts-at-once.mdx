...
- In block [Payload Types for Mutations](/guides/config/returning-a-payload-object-or-the-mutated-entity-for-mutations), select "Use payload types for mutations, and add fields to query those payload objects"
