---
title: Lesson 1550 - Modifying (and storing again) the image URLs from all Image blocks in a post
description: Tutorial lesson on iterating the inner structure of (Gutenberg) blocks, extracting desired items, modifying them, and storing them again in the DB.
