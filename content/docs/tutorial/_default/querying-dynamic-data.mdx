---
title: Querying dynamic data
metaDesc: Gato GraphQL allows us to dynamically compute data, input it back into the query, and affect the response with granular control. Here is how.
