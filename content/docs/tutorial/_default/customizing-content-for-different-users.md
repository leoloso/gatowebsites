---
title: Customizing content for different users
metaDesc: Tutorial lesson on retrieving a different response in a field depending on some piece of queried data, such as the roles of the logged-in user.
