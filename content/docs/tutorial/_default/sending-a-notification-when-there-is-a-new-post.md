---
title: Sending a notification when there is a new post
metaDesc: Examples on automating tasks in the application, such as sending a notification email to the admin when there is a new post.
