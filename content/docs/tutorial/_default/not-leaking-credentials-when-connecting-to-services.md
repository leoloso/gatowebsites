---
title: Not leaking credentials when connecting to services
metaDesc: Tutorial lesson on retrieving credentials from an environment value, as to avoid them getting printed in the response or logs, thus avoiding security risks.
