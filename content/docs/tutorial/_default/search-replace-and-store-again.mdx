---
title: "Lesson 6: Search, replace, and store again"
...
{/* It requires the **[PHP Functions via Schema](/extensions-reference/php-functions-via-schema)** extension. */}

<Banner type="info">

The **[PHP Functions via Schema](/extensions-reference/php-functions-via-schema)** extension provides the following "search and replace" fields:
