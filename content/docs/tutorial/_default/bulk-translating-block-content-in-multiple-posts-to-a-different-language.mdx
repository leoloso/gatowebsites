---
title: "Lesson 1540: Bulk translating block content in multiple posts to a different language"
description: "Tutorial lesson for translating multiple posts at once (in bulk), while executing a single call to the Google Translate API containing all text to translate from all the posts."
