...
metaDesc: "Addition of fields to retrieve the current HTTP request data."
...
![Configuring the $_SERVER property name to retrieve the client IP](/assets/extensions/upstream-pro/settings-general-client-ip-address-server-property-name.png "Configuring the $_SERVER property name to retrieve the client IP")
