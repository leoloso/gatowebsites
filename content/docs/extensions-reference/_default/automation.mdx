...
![Automation Rule - Persisted Query Execution](/assets/extensions/upstream-pro/automation-mapping-persisted-query-execution.png)
...
![Automation Rule - Action hook](/assets/extensions/upstream-pro/automation-mapping-action-hook.png)
