...
metaDesc: "Translate content to multiple languages using the Google Translate API."
...
![Setting Google Translate's API key](/assets/extensions/upstream-pro/settings-google-translate-api-key.png "Setting Google Translate's API key")
...
![Setting the default "from" and "to" languages](/assets/extensions/upstream-pro/settings-google-translate-from-to-fields.png "Setting the default 'from' and 'to' languages")
...
- [Translating content from URL](../../tutorial/translating-content-from-url) -->
