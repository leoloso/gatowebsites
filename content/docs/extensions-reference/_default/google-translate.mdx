...
{/* <Image
  src=/assets/extensions/upstream-pro/settings-google-translate-api-key.png
  width="1024"
  height="940"
  alt=Setting Google Translate's API key
  caption=Setting Google Translate's API key
/> */}

![Setting Google Translate's API key](/assets/extensions/upstream-pro/settings-google-translate-api-key.png)
...
{/* <Image
  src=/assets/extensions/upstream-pro/settings-google-translate-from-to-fields.png
  width="1024"
  height="940"
  alt=Setting the default "from" and "to" languages
  caption=Setting the default "from" and "to" languages
/> */}

![Setting the default "from" and "to" languages](/assets/extensions/upstream-pro/settings-google-translate-from-to-fields.png)
