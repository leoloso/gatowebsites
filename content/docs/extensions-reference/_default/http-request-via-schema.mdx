...
{/* <Image
  src=/assets/extensions/upstream-pro/settings-general-client-ip-address-server-property-name.png
  width="1024"
  height="940"
...
![Configuring the $_SERVER property name to retrieve the client IP](/assets/extensions/upstream-pro/settings-general-client-ip-address-server-property-name.png)
