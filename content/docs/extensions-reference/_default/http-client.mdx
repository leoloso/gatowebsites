...
{/* <Image
  src=/assets/extensions/upstream-pro/http-requests-settings-entries.png
  width="1024"
  height="940"
...
![Defining the entries for the Settings](/assets/extensions/upstream-pro/http-requests-settings-entries.png)
...
{/* <Image
  src=/assets/extensions/upstream-pro/http-requests-settings-behavior.png
  width="1024"
  height="940"
...
![Defining the access behavior](/assets/extensions/upstream-pro/http-requests-settings-behavior.png)
