...
metaDesc: "Manipulate the field output using standard programming language functions available in PHP."
...
- [Search, replace, and store again](../../tutorial/search-replace-and-store-again)
- [Adapting content in bulk](../../tutorial/adapting-content-in-bulk)
- [Site migrations](../../tutorial/site-migrations)
...
- [Sending emails with pleasure](../../tutorial/sending-emails-with-pleasure)
...
- [Interacting with external services via webhooks](../../tutorial/interacting-with-external-services-via-webhooks)
- [Retrieving data from an external API](../../tutorial/retrieving-data-from-an-external-api)
- [Combining user data from different sources](../../tutorial/combining-user-data-from-different-sources)
