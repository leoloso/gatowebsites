...
![Access Control Lists](/assets/extensions/upstream-pro/access-control-lists.png)
...
![Selecting an Access Control List in the Schema Configuration](/assets/extensions/upstream-pro/schema-config-access-control-lists.png)
