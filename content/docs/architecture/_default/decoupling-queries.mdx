...
- Adding any directive through [IFTTT through directives](/architecture/ifttt-through-directives)
- Defining a strict [field-execution order](/architecture/manipulating-field-resolution-order) for Multiple Query Execution
