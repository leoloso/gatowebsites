...
![Field with nested query "Field with nested query"](/assets/architecture/connection-nested-query.jpg)
...
![Field without nested query "Field without nested query"](/assets/architecture/connection-alone.jpg)
