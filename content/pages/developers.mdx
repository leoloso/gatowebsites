...
The Gato GraphQL plugin can be augmented via the [extensions](/extensions) shipped via Gato GraphQL PRO, which add more functionality and extend the GraphQL schema.
