...
With [Field to Input](/features/field-to-input), you can retrieve the value of a field, and provide it as input to another field (PRO).
...
For instance, the following query converts translates the category names to French:
