...
![Persisted query editor](/assets/guides/upstream/persisted-query.png)
...
![Access Control List editor](/assets/extensions/upstream-pro/access-control-list.png)
...
![Password-protected Custom Endpoint](/assets/guides/upstream/password-protected-custom-endpoint.png)
...
![Namespaced interactive schema](/assets/guides/upstream/namespaced-interactive-schema.png)
