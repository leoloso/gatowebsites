...
GraphQL can be used for much more than just as an API.

We can use GraphQL to fetch data from the database, modify it as required, and store it back, all of it within a single GraphQL document. This means that GraphQL can also be used as a tool to manage our WordPress sites, satisfying the use cases of many WordPress plugins.
